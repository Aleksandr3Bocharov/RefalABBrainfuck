...
clang -o bin\RefalABBrainfuck.exe src\RefalABBrainfuck.o src\Interpretator.o src\Interpretatorc.o %REFALABLIB%\mainrf.o -L%REFALABLIB% -lRefalAB >> RefalABBrainfuck.log
