...
clang -o RefalABBrainfuck_gui.exe RefalABBrainfuck_gui.o RefalABBrainfuckc_gui.o Interpretator.o %REFALABLIB%\mainrf.o -L%REFALABLIB% -lRefalAB gui.o %RAYLIBLFLAGS% >> RefalABBrainfuck_gui.log
